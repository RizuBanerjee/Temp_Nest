...
Temporary email SaaS platform with credit-based usage, free/pro/business plans, admin dashboard, Clerk auth, Stripe payments, Mail.tm email integration, and OTP extraction.
...
- Clerk dev keys show a console warning — expected in development
